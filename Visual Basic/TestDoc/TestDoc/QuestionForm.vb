...
#End Region
    ...
    Private Sub checkIfApproved()
        ' Dim query As String = "SELECT (ssn, date) FROM Answer VALUES(user.ssn = answer.ssn & date & "todayDate-90Days") " Then
        Dim todaysDate = Today.AddDays(-90).ToString("dd/MM/yyyy")
        Try

            connection.Open()

            Dim query As String = "SELECT last_drain FROM Blood_Data WHERE ss_number='" & LogIn.txtPersonnr.Text & "'"
            ...
            While reader.Read()
                lastDrain = reader("last_drain").ToString & " "
            End While
            MsgBox(lastDrain)
        ...
        Finally
            connection.dispose()
        End Try
        'går rett til spørreskjema
        'Else 
        'Msgbox(Du må dessverre vente til det har gått 3 måneder)
    ...
    Private Sub quarantine() 'As Boolean
            ...
            ' Dim talkToBloodCenter As Boolean ' = Avvent med status
            Dim listQuarantine As New List(Of Object)()
            Dim lifeTimequarantine As String = "Du har ikke lov å gi blod."
            ...
            'SJEKKE AT DET ER TRE MÅNEDER SIDEN SIST TAPPING
            'KOBLE OPP PERSONNUMMER MED DENNE
            'connection.Open()
            'Dim reader As MySqlDataReader
            ...
            ElseIf rbNei2.Checked Or rbNei3.Checked Or rbNei4.Checked Or rbJa7.Checked Or rbJa12.Checked Or rbJa13.Checked Or rbJa14.Checked Or rbJa21.Checked Or rbJa22.Checked Or rbJa24.Checked Or rbJa25.Checked Or rbJa33.Checked Or rbJa37.Checked Or rbJa38.Checked Or rbJa39.Checked Or rbJa40.Checked Or rbJa41.Checked Or rbJa47.Checked Or rbJa48.Checked Or rbJa50.Checked Or rbJa53.Checked Or rbJa56.Checked Then
                totalQT = "Du har ett eller flere spørsmål besvart som må tas opp opp på helsesjekken."
            Else
                totalQT = ""
            End If
            MsgBox("Karantene: " & totalQT)
        ...
        Try
                ...
                connection.close()
            Catch ex As Exception
                MsgBox("Vennligst sjekk at du har besvart alle spørsmål.", MsgBoxStyle.Information)
            Finally
                connection.dispose()
            End Try
