...
#End Region
    ...
    Private Sub BtnOrderApp_Click(sender As Object, e As EventArgs) Handles btnOrderApp.Click
        ...
        ElseIf lblQuarantine.Text = "Ingen verdi" Then
            OrderApp()
        ElseIf Not lblQuarantine.Text = "Godkjent" Then
            MsgBox("Brukeren har karantene til: " & lblQuarantine.Text, MsgBoxStyle.Critical, "Oops!")
